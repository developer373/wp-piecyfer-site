...
class UpdraftPlus_Addons_RemoteStorage_webdav extends UpdraftPlus_RemoteStorage_Addons_Base_v2 {
	...
	protected $input_option_field_mappings = array(
		...
		'enable_chunk' => array(
			'default_value' => 1,
			'template_property_input_mapping' => 'chunk',
	...
	public function get_template_properties() {
		...
		$properties = array(
			...
			'input_protocol_option_labels' => array(
				'webdav://' => 'webdav://',
				'webdavs://' => 'webdavs://',
			),
			...
			'input_host_placeholder' => __('Example: dav.example.com', 'updraftplus'),
			...
			'input_path_label' => __('Path', 'updraftplus'),
			'input_path_placeholder' => __('Example: remote.php/dav/files/user', 'updraftplus'),
			'input_chunk_label' => __('Split uploads into chunks', 'updraftplus'),
			'input_chunk_title' => __('Yes', 'updraftplus'),
			'input_chunk_type' => 'checkbox',
...
<D:owner>%s</D:owner> 
	...
	public function configure_field_from_legacy($field, $template_properties, $field_name, $option) {
		...
		if (empty($field['tooltip']) && 'enable_chunk' !== $field['id'] && isset($template_properties[$prefix.'title'])) $field['tooltip'] = array('text' => $template_properties[$prefix.'title']);
