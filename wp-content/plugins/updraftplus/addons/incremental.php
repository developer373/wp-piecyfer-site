	...
	public function admin_footer_incremental_backups_js() {
		...
		jQuery(function() {
			<?php
				...
				// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- $intervals_json is safely encoded via wp_json_encode()/json_encode() for JavaScript context; esc_html() would break the JSON structure.
