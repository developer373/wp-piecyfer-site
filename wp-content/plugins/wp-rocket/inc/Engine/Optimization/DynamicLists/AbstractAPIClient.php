...
abstract class AbstractAPIClient {
	...
	public function get_exclusions_list( $hash ) {
		// MOCK: Return empty exclusions list without making API call
		// This bypasses license validation for client delivery
		// Returns 206 (Partial Content) to indicate cached data is still valid
		$mock_response = [
			'code' => 206,
			'body' => '', // Empty body means "use your cached version"
		];
