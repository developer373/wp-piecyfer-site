...
> Subset comparison: `p4b-verify` covers 8 of the 39 pages in `baseline`. 124 artefact(s) in the baseline were not re-captured this run and are not counted as missing. Run the full set before closing out a phase.
